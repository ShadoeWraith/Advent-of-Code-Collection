...
The database operates on **_ingredient IDs._** It consists of a list of fresh **_ingredient ID ranges,_** a blank line, and a list of **_available ingredient IDs._** For example:
